    ...
    with open("book's_information_category.csv", "w") as p:
        ...
        for books_link in books_links:
            ...
            csv_writer.writerow(
                {
                    ...
                    "price_including_tax": data["price_including_tax"].text.replace(
                        "Â", ""
                    ),
                    "price_excluding_tax": data["price_excluding_tax"].text.replace(
                        "Â", ""
                    ),
                    ...
                    "image_url": data["image_url"]["src"].replace(
            ...
            response = requests.get(
                ""
                + data["image_url"]["src"].replace("../..", "http://books.toscrape.com")
                + ""
            )
            function.download_image(data)
