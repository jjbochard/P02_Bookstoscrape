...
if choice == 'book':
    ...
    response = requests.get("" + image_url['src'].replace('../..', 'http://books.toscrape.com') + "")
...
if choice == 'category':
    ...
    get_url_books_for_a_category_page('http://books.toscrape.com/catalogue/category/books/mystery_3/index.html')
    ...
    with open('book\'s_information_category.csv', 'w') as p:
        ...
        for books_link in books_links:
            get_books_informations(books_link)
            csv_writer.writerow({
